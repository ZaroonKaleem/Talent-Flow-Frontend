...
import { EmployeeProfileRequestComponent } from './Components/employee-dashboard/employee-profile-request/employee-profile-request.component';
import { EmployeeTransferRequestComponent } from './Components/employee-dashboard/employee-transfer-request/employee-transfer-request.component';
import { EmployeeInfoRequestComponent } from './Components/employee-dashboard/employee-info-request/employee-info-request.component';
import { EmployeeRegisterationRequestComponent } from './Components/employee-dashboard/employee-registeration-request/employee-registeration-request.component';
import { EmployeeApprovalRequestComponent } from './Components/employee-dashboard/employee-approval-request/employee-approval-request.component';
import { EmployeeDelegationRequestComponent } from './Components/employee-dashboard/employee-delegation-request/employee-delegation-request.component';
        ...
        children: [
            {
                ...
                children: [
                    ...
                    { path: 'manage-resign-type', component: ManageResignTypeComponent },
                    { path: 'manage-expense-unit', component: ManageExpenseUnitComponent },
                    { path: 'manage-exit-type', component: ManageExitTypeComponent },
                    { path: 'manage-marital-status', component: ManageMaritalStatusComponent },
                    { path: 'manage-document-type', component: ManageDocumentTypeComponent },
                    { path: 'manage-gl-class', component: ManageGlClassComponent },
                    { path: 'manage-cost-center', component: ManageCostCenterComponent },
                    { path: 'manage-region', component: ManageRegionComponent },
                    { path: 'manage-vendor', component: ManageVendorComponent },
                    { path: 'manage-area', component: ManageAreaComponent },
