...
export class EmployeeAreaService {
    private apiUrl = `${environment.apiUrl}services/app/Area`;
    ...
    createArea(areaData: {
        ...
        return this.http.post<any>(`${this.apiUrl}/Create`, areaData, {
            headers,
        });
    }
    ...
    updateArea(area: {
        ...
        return this.http.put<any>(`${this.apiUrl}/Update`, area, {
            headers,
        });
    }
}
