...
export class EmployeeUniversityService {
private apiUrl = `${environment.apiUrl}services/app/University`;
    ...
    return this.http.get<any>(`${this.apiUrl}/GetAll`, {
      ...
      params: httpParams
       ...
       createUniversity(universityData: {
        ...
        return this.http.post<any>(`${this.apiUrl}/Create`, universityData, {
            headers,
        });
    }
