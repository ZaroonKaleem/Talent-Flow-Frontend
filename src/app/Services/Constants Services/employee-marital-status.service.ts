...
private apiUrl = `${environment.apiUrl}services/app/MaritalStatus`;
  ...
  createMaritalStatus(maritalStatusData: {
        id: number;
        name: string;
    }): Observable<any> {
        const token = localStorage.getItem('accessToken');
        ...
        return this.http.post<any>(`${this.apiUrl}/Create`, maritalStatusData, {
            headers,
        });
    }
     ...
     */
    updateMaritalStatus(maritalStatusData: {
        id: number;
        name: string;
    }): Observable<any> {
        const token = localStorage.getItem('accessToken');
        ...
        return this.http.put<any>(`${this.apiUrl}/Update`, maritalStatusData, {
            headers,
        });
  }
}
