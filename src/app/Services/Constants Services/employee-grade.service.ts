...
private apiUrl = `${environment.apiUrl}services/app/Grade`;
  ...
  return this.http.post<any>(`${this.apiUrl}/Create`, gradeData, { headers });
}
...
deleteGrade(id: number): Observable<any> {
    ...
    updateGrade(gradeData: {
        ...
        return this.http.put<any>(`${this.apiUrl}/Update`, gradeData, {
            headers,
        });
  }
}