...
export class EmployeeFloorService {
private apiUrl = `${environment.apiUrl}services/app/Floor`;
  ...
  getAllEmployeeStations(params?: any): Observable<any> {
    ...
    return this.http.get<any>(`${this.apiUrl}/GetAll`, {
     ...
     createFloor(FloorData: {
        ...
        return this.http.post<any>(`${this.apiUrl}/Create`, FloorData, {
            headers,
        });
    }
    ...
    return this.http.delete<any>(`${this.apiUrl}/Delete`, {
     ...
     /**
      ...
      updateFloor(FloorData: {
          ...
          return this.http.put<any>(`${this.apiUrl}/Update`, FloorData, {
              headers,
          });
    }
}
