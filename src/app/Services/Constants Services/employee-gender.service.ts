...
export class EmployeeGenderService {
private apiUrl = `${environment.apiUrl}services/app/Gender`;
  ...
  getAllEmployeeStations(params?: any): Observable<any> {
    ...
    return this.http.get<any>(`${this.apiUrl}/GetAll`, {
      ...
      params: httpParams
        ...
        return this.http.post<any>(`${this.apiUrl}/Create`, genderData, {
            headers,
        });
    }
    ...
    return this.http.delete<any>(`${this.apiUrl}/Delete`, {
     ...
     /**
      ...
      updateGender(genderData: {
          ...
          return this.http.put<any>(`${this.apiUrl}/Update`, genderData, {
              headers,
          });
    }
}
