...
@Component({
  selector: 'app-employee-info-request',
  standalone: true,
   imports: [
  ...
  templateUrl: './employee-info-request.component.html',
  styleUrl: './employee-info-request.component.scss'
})
export class EmployeeInfoRequestComponent implements OnInit {
...
vendorOptions: any[] = [];
  ...
  requestTypes = ['Personal Data', 'Employment History', 'Salary Information', 'All Records'];
