...
@Component({
    ...
    template: `
        <h2 mat-dialog-title>Edit Job Title</h2>
        <mat-dialog-content>
...
export class EditJobTitleDialogComponent {
    constructor(
        public dialogRef: MatDialogRef<EditJobTitleDialogComponent>,
        @Inject(MAT_DIALOG_DATA) public data: { id: number; name: string; description: string }
    ) {}
